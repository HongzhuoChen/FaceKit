...
| [`PRIVACY.md`](PRIVACY.md) | The privacy audit — inputs, the two axes (identity, appearance), the flagging and NNAA statistics, output files, and how to read the manuscript's result. |
