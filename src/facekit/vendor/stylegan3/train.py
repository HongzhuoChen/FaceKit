...
@click.option('--lr-schedule',  help='Learning-rate schedule (FaceKit modification)',           type=click.Choice(['constant', 'cosine']), default='constant', show_default=True)
...
def main(**kwargs):
    ...
    c.lr_schedule = opts.lr_schedule # FaceKit modification.
